 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Yi Hu");
		  toPrint += p1.toString("yhu453");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Junyang Zhang");
		  toPrint += p2.toString("jzhang3027");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Anthony Zheng");
		  toPrint += p3.toString("azheng47");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Diana Liu");
          toPrint += p4.toString("dliu320");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Haoran Xin");
          toPrint += p5.toString("hxin33");
